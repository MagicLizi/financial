  ...
  function render() {
    ...
    data.forEach( function( point, i ) {
      if( i <= progressDots ) {
        ...
        context.fillStyle = point.future ? '#aaa' : '#333';
...
function reset() {
  chart.populate([
    { label: 'One', value: 100,future:false },
    { label: 'Two', value: 300 },
    { label: 'Three', value: 900 },
    { label: 'Four', value: 840 },
    { label: 'Five', value: 620 },
    { label: 'Six', value: 500 },
    { label: 'Seven', value: 600 },
    { label: 'Eight', value: 1100 },
    { label: 'Nine', value: 400 , future: true },
    { label: 'Ten', value: 900, future: true  },
    { label: 'Eleven', value: 1000, future: true },
    { label: 'Twelve', value: 1200, future: true }
  ]);
}
